...
const CloseButton = ({ onClose }: { onClose: () => void }) => {
  return (
    <button
      onClick={onClose}
      className={`relative z-10 shrink-0 p-3 text-base font-medium text-neutral-800 bg-white rounded-full cursor-pointer flex items-center gap-3 border cursor-pointer
