...
import { FeaturedProductsProps } from "@/src/lib/types/store-front";
          ...
          return (
            <div key={p.id} className="flex flex-col gap-2">
              ...
              >
                ...
                />
                <div className="bg-black  rounded-md absolute top-5 left-5 uppercase text-[10px] font-semibold tracking-widest p-2">
                  <Star color="yellow" />
                </div>
                {quantity <= 5 && quantity >= 1 && (
                  <div className="bg-white rounded-md absolute top-5 right-5 uppercase text-[10px] font-semibold tracking-widest p-2">
                    last few
                  </div>
                )}
              </Link>
