...
const StoreButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative z-10 shrink-0 px-6 py-3.5 text-base font-medium text-neutral-800 bg-white rounded-full cursor-pointer flex justify-center items-center gap-3 border-2 ${whiteBorder ? "border-white" : "border-black"}
